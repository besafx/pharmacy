    ...
    public Future<byte[]> getFile(String timeType) throws Exception {
        ...
        switch (timeType) {
            case "Day":
                ...
                title.append("تقرير يومي للمبيعات الخارجية حسب الفترة من");
                title.append(" ");
                break;
            case "Week":
                ...
                title.append("تقرير اسبوعي للمبيعات الخارجية حسب الفترة من");
                title.append(" ");
                break;
            case "Month":
                startDate = new DateTime().withDayOfMonth(1).withTimeAtStartOfDay();
                endDate = startDate.plusMonths(1).minusDays(1);
                title.append("تقرير شهري للمبيعات الخارجية حسب الفترة من");
                title.append(" ");
                break;
            case "Year":
                startDate = new DateTime().withDayOfYear(1).withTimeAtStartOfDay();
                endDate = startDate.plusYears(1).minusDays(1);
                title.append("تقرير سنوي للمبيعات الخارجية حسب الفترة من");
                title.append(" ");
                break;
        }
