app.controller('insideSalesDetailsCtrl', ['BillSellService', 'BillSellReceiptService', 'TransactionSellService', 'OrderService', 'ModalProvider', '$scope', '$rootScope', '$timeout', '$uibModalInstance', '$uibModal', 'billSell',
    function (BillSellService, BillSellReceiptService, TransactionSellService, OrderService, ModalProvider, $scope, $rootScope, $timeout, $uibModalInstance, $uibModal, billSell) {
        ...
        $scope.refreshOrder = function () {
            OrderService.findOne($scope.billSell.order.id).then(function (data) {
                return $scope.billSell.order = data;
            });
        };
