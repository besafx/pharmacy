...
(function (ng, undefined) {
    ...
    ng.module('smart-table', []).run(['$templateCache', function ($templateCache) {
        $templateCache.put('template/smart-table/pagination.html',
            ...
            '<li ng-repeat="page in pages"><a ng-class="{\'mdl-color--primary-dark mdl-color-text--white\': page==currentPage}" href="javascript: void(0);" ng-click="selectPage(page)">{{page}}</a></li>' +
            '</ul></nav>');
    }]);
